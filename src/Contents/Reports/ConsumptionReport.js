...
export const ConsumptionReport = (props) => {
    ...
    <>
        <div className="row page-titles">
            <div className="col-md-5 align-self-center">
                <h4 className="text-themecolor">Consumption Report</h4>
            </div>
            ...
            <div className="card w-100">
                <div className="card-body">
                    <div className="content mt-5">
                        ...
                        <h3 className="text-center mt-5">Consumption Report of Menus</h3>
                        ...
                        <h3 className="text-center mt-5">Consumption Report of Variant</h3>
                        <div className="table-responsive mt-5">
                            <table
                            id="zero_config2"
                            className="table table-striped table-bordered"
