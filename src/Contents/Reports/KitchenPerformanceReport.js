...
export const KitchenPerformanceReport = (props) => {
    ...
    <>
        <div className="row page-titles">
            <div className="col-md-5 align-self-center">
                <h4 className="text-themecolor">Kitchen Performance Report</h4>
            </div>
            <div className="col-md-7 align-self-center text-right">
                <div className="d-flex justify-content-end align-items-center">
                    ...
                    <li className="breadcrumb-item active">Kitchen Performance Report</li>
                    </ol>
                </div>
            </div>
        </div>
