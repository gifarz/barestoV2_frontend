...
export const CustomerWhoAnniversary = (props) => {
    ...
    <>
        <div className="row page-titles">
            <div className="col-md-5 align-self-center">
                <h4 className="text-themecolor">Customer Who Anniversary</h4>
            </div>
            <div className="col-md-7 align-self-center text-right">
                <div className="d-flex justify-content-end align-items-center">
                    ...
                    <li className="breadcrumb-item active">Customer Who Anniversary</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div className="form-row">
                        <div className="form w-50">
                            ...
                            <div className="form-group">
                                ...
                                value="Wishing you Happy Anniversary from Warung Kukuruyuk. Please come to our restaurant and enjoy discount in your special day."
                                />
                            </div>
                            <p>There are 0 customer has anniversary today. </p>
                            <div>
